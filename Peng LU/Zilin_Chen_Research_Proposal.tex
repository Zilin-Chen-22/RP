...
The research will commence with the development of high-fidelity kinematic and dynamic models of the drone. Employing Physics-based simulations (e.g. MuJoCo~\cite{todorov2012mujoco}) to analyze both flight and perching stability, thereby informing the design of control strategies and enabling reliable adsorption perching on surfaces with arbitrary inclination.

\subsection{Learning-Based Perching Policy Development}
To enhance robustness and generalizability, learning-based methods will be incorporated alongside model-based control. Training reinforcement learning policies in simulation to enable fully autonomous operation—including visual identification of suitable perching sites, navigation to the target, and execution of the attachment procedure.

\subsection{System Integration and Experimental Validation}
All sensing, control, and perception modules are integrated into a unified UAV platform. This includes an autonomous navigation controller, a VSERF-based perching mechanism, and a vision system. The system's performance is evaluated through comprehensive real-world experiments, focusing on the success rate of autonomous perching, attachment time, adaptability to different surfaces, and the overall extension of flight endurance.
